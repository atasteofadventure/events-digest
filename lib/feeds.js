...
function makeEvent({ sourceName, name, dateISO, time, venue, price, url, why, category }) {
  return {
...
function icsToEvents(text, { sourceName, defaultCategory }) {
...
function jsonLdToEvents(html, { sourceName, defaultCategory }) {
  const found = [];
